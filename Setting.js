...
global.Gname = process.env.GNAME || "꧁☆STRANGER☆꧂",
...
global.owner = process.env.OWNER_NUMBER  || '923444844060' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923444844060" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '06_07_2024_SIGMA_MD_BT7LJzYC_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'RAI-KING',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `꧁☆STRANGER☆꧂`, // ADD YOUR NAME
  ...
  warncount : process.env.WARN_COUNT || 7,                 // WARN LIMITS
